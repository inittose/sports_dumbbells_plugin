...
namespace SportsDumbbellsPlugin.Controls
{
    public partial class RodParametersControl : UserControl
    {
        ...
        {
            textBoxCenterLength.Text = DumbbellConstraints.DefaultCenterLength.ToString(CultureInfo.InvariantCulture);
            textBoxSeatLength.Text = DumbbellConstraints.DefaultSeatLength.ToString(CultureInfo.InvariantCulture);
            textBoxHandleDiameter.Text = DumbbellConstraints.DefaultHandleDiameter.ToString(CultureInfo.InvariantCulture);
            textBoxSeatDiameter.Text = DumbbellConstraints.DefaultSeatDiameter.ToString(CultureInfo.InvariantCulture);
        }
